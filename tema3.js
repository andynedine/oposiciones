const tema3 = [
    ...
    },
    {
        ...
        opciones: ['El Municipio y la Provincia.', 'El Municipio, la Provincia y la Isla en los archipiélagos balear y canario.', 'El Municipio, la Provincia, las Áreas Metropolitanas y las Mancomunidades de Municipios.', 'Las Comarcas, las Áreas Metropolitanas y Las Mancomunidades de Municipios.'],
    ...
    {
        pregunta: "En la Ley 7/1985, de 2 abril, dispone que las Entidades Locales, en su calidad de Administraciones públicas de carácter territorial, y dentro de la esfera de sus competencias, corresponden en todo caso a los municipios, las provincias y las islas, una serie de potestades, regulándose las mismas en el artículo:",
        opciones: ['4', '5', '6', '2.1'],
        respuesta: "4"
    },
    {
        pregunta: "En todos los Ayuntamientos ha de existir el siguiente órgano:",
        opciones: ['La Junta de Gobierno.', 'Las Juntas Municipales de Distrito.', 'La Comisión Especial de Cuentas.', 'Los Concejales que ostentes delegaciones.'],
        respuesta: "La Comisión Especial de Cuentas."
    },
    {
        pregunta: "En relación a los Vicepresidentes de la Diputación, según dispone la Ley 7/1985, de 2 de abril:",
        opciones: ['Son nombrados por el Pleno al comienzo de su mandato.', 'Son como mucho dos.', 'Son designados libremente por el presidente de entre todos los Diputados.', 'Sustituyen al Presidente en caso de enfermedad por el orden de su nombramiento.'],
    ...
    {
        pregunta: "Conforme al artículo 15 de la Ley 7/1985, de 2 de abril, ¿qué constituye el conjunto de personas inscritas en el Padrón municipal?",
        opciones: ['Los vecinos del municipio.', 'La población del municipio.', 'Término municipal.', 'Ciudadanos municipales.'],
    ...
    },
    {
        ...
        opciones: ['A las Comunidades Autónomas que se constituyan.', 'A los Municipios, Provincias e Islas.', 'A los Municipios, provincias y Comunidades Autónomas que se constituyan.', 'A los Municipios, Provincias, Islas y Comunidades Autónomas que se constituyan.'],
        respuesta: "A los Municipios, provincias y Comunidades Autónomas que se constituyan."
    },
    {
        pregunta: "¿A quién corresponde la jefatura superior del personal de la Diputación según establece la Ley 7/1985, de 2 de abril?",
        opciones: ['Al Pleno en todo caso.', 'Al Presidente en todo caso.', 'Al Diputado-Delegado de personal.', 'Al Presidente o al Diputado Provincial.'],
        respuesta: "Al Presidente en todo caso."
    },
    {
        pregunta: "¿Cómo está constituido el Pleno de la Diputación según el artículo 33.1 de la Ley 7/1985, de 2 de abril?",
        opciones: ['Por el Presidente y los Diputados.', 'Los miembros que disponga cada Reglamento Orgánico.', 'Los Diputados Provinciales.', 'El Presidente, el Secretario y los Diputados.'],
    ...
    },
    {
        ...
        opciones: ['Los Tenientes de Alcalde.', 'Los Diputados Delegados.', 'La Junta de Gobierno.', 'Las Juntas de distrito.'],
        respuesta: "La Junta de Gobierno."
    },
    {
        pregunta: "Las Áreas Metropolitanas, según la Ley 7/1985, de 2 abril:",
        opciones: ['Son de preceptiva creación en los términos fijados en la misma.', 'Son entidades locales.', 'Carecen de la consideración de entidad local.', 'Equivalen a las Mancomunidades allí donde no existen.'],
    ...
    {
        pregunta: "¿Qué consideración tiene la Provincia según la Ley 7/1985, de 2 de abril?",
        opciones: ['Una Entidad local básica.', 'Una Entidad local territorial.', 'El órgano de administración de las Diputaciones.', 'Una entidad integrante en la Comunidad Autónoma.'],
        respuesta: "Una Entidad local territorial."
    },
    {
        pregunta: "Entre los elementos del municipio de encuentra:",
        opciones: ['El Ayuntamiento.', 'La autonomía.', 'El territorio.', 'La Junta de Gobierno Local.'],
    ...
    },
    {
        ...
        opciones: ['La Provincia.', 'El Municipio.', 'La Diputación Provincial.', 'La Mancomunidad de Municipios.'],
    ...
    },
    {
        ...
        opciones: ['A las Cortes Generales, mediante Ley Orgánica.', 'A las Comunidades Autónomas, cuando lo dispongan sus Estatutos expresamente.', 'A los Parlamentos Autonómicos.', 'Lo deciden los vecinos de los municipios que pudieran verse afectados.'],
    ...
    },
    {
        ...
        opciones: ['Protección de medio ambiente urbano.', 'Transporte interurbano de viajeros.', 'Ordenación del tráfico en vías interurbanas.', 'Protección de carreteras.'],
        respuesta: "Protección de medio ambiente urbano."
    },
    {
        pregunta: "¿Qué regula el artículo 142 de la Constitución Española?",
        opciones: ['Las Haciendas Locales.', 'El Municipio.', 'La elección de los Alcaldes.', 'Las Comunidades Autónomas.'],
    ...
    },
    {
        ...
        opciones: ['Las personas residentes en el Municipio.', 'Las personas inscritas en el Padrón Municipal.', 'Los españoles y extranjeros mayores de edad residentes en el Municipio.', 'Las personas inscritas en el Padrón, con una antigüedad de 3 meses de dicha inscripción.'],
        respuesta: "Las personas inscritas en el Padrón Municipal."
    },
    {
        pregunta: "¿Cómo se nutrirán fundamentalmente las Haciendas Locales según la Constitución Española?",
        opciones: ['De los tributos impuestos por las Comunidades Autónomas.', 'De tributos propios y participación en los del Estado y las Comunidades Autónomas.', 'De los tributos propios, principalmente.', 'De la participación en los tributos del Estado y de tributos cedidos.'],
        respuesta: "De tributos propios y participación en los del Estado y las Comunidades Autónomas."
    },
    {
        pregunta: "¿Cómo es elegido el Alcalde, de acuerdo a la Ley 7/1985, de 2 de abril?",
        opciones: ['Por los Concejales del Ayuntamiento.', 'Por los Concejales o por los vecinos.', 'Por sufragio universal, libre, y secreto, en todos los supuestos.', 'Por los vecinos en todo caso.'],
        respuesta: "Por los Concejales o por los vecinos."
    },
    {
        pregunta: "¿A quién le corresponde aprobar la oferta de empleo público en el ámbito municipal, según la Ley 7/1985, de 2 de abril?",
        opciones: ['Al Pleno.', 'A la Junta de Gobierno.', 'Al Alcalde.', 'Al Alcalde de acuerdo con el presupuesto y la plantilla aprobados por la Junta de Gobierno.'],
        respuesta: "Al Alcalde."
    },
    {
        pregunta: "Los Tenientes de Alcalde, según el artículo 23 de la Ley 7/1985, de 2 de abril:",
        opciones: ['Son nombrados por el Pleno al comienzo de su mandato.', 'No pueden exceder, en su número, de tres.', 'Han de ser nombrados de entre los miembros de la Junta de gobierno, donde ésta exista.', 'Pueden ser cesados por el Pleno.'],
        respuesta: "Han de ser nombrados de entre los miembros de la Junta de gobierno, donde ésta exista."
    },
    {
        pregunta: "Entre las competencias de la Junta de Gobierno de un Ayuntamiento atribuidas por la Ley 7/1985, de 2 de abril, se encuentra:",
        opciones: ['Asistencia al alcalde en el ejercicio de sus funciones.', 'Estudio de los asuntos que hayan de ser sometidos a la decisión del Pleno.', 'Emisión de los informes preceptivos requeridos por otras Administraciones Públicas.', 'Resolución, por delegación del Pleno, de los asuntos menores.'],
    ...
    {
        pregunta: "¿Qué nombre recibe la administración propia de las islas en los archipiélagos balear y canario, según se dispone en el artículo 141.4 de la Constitución Española?",
        opciones: ['Comunidades Autónomas.', 'Mancomunidades de Municipios.', 'Diputaciones Insulares.', 'Los Consejos y Cabildos.'],
        respuesta: "Los Consejos y Cabildos."
    },
    {
        pregunta: "Las Diputaciones Provinciales se mencionan expresamente en la Constitución Española de 1978, en el artículo:",
        opciones: ['137.', '142.1', '141.1', '141.2.'],
        respuesta: "141.2."
    },
];
