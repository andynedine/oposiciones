const tema2 = [
    ...
    },
    {
        ...
        opciones: ['Tienen la obligación de intervenir en el procedimiento.', 'Tienen la condición de interesados en el procedimiento.', 'Tienen derecho a que se le reintegren los gastos que ello les origine.', 'Pueden tener la condición de interesados en el procedimiento.'],
        respuesta: "Tienen la condición de interesados en el procedimiento."
    },
    {
        pregunta: "La representación en un procedimiento administrativo, según el artículo 5 de la Ley 39/2015 de 1 de octubre, del Procedimiento Administrativo Común de las administraciones Públicas:",
        opciones: ['Puede asumirse por cualquier persona que designe el interesado.', 'Habrá de acreditarse siempre que la Administración lo requiera.', 'Habrá de ostentarla un Gestor Administrativo en todo caso.', 'Se presume para los actos de mero trámite.'],
    ...
    {
        pregunta: "Cuando la condición de interesado derivase de alguna relación jurídica transmisible el derecho- habiente sucederá en tal condición, según dispone el artículo 4.3 de la Ley 39/2015 de 1 de octubre, del Procedimiento Administrativo Común de las administraciones Públicas:",
        opciones: ['Cualquiera que sea el estado del procedimiento.', 'Si el procedimiento no ha alcanzado el trámite de información pública.', 'Si el procedimiento no ha alcanzado el trámite de audiencia.', 'Si el procedimiento no ha alcanzado la fase de instrucción.'],
    ...
    {
        pregunta: "Según se dispone en el artículo 5 de la Ley 39/2015, de 1 de octubre, del Procedimiento Administrativo Común de las Administraciones Públicas, la falta o insuficiente acreditación de la representación no impedirá que se tenga por realizado el acto de que se trate, siempre que se aporte aquélla o se subsane el defecto dentro del plazo de:",
        opciones: ['20 días o de un plazo superior cuando las circunstancias del caso así lo requieran.', '15 días o de un plazo superior cuando las circunstancias del caso así lo requieran.', '10 días o de un plazo superior cuando las circunstancias del caso así lo requieran.', '5 días o de un plazo superior cuando las circunstancias del caso así lo requieran.'],
    ...
    {
        pregunta: "Según el artículo 28 de la Ley 39/2015, cuando se trate de informes preceptivos ya elaborados por un órgano administrativo distinto al que tramita el procedimiento, éstos deberán ser remitidos en el plazo de:",
        opciones: ['10 días a contar desde su solicitud.', '15 días a contar desde su solicitud.', '20 días a contar desde su solicitud.', '30 días a contar desde su solicitud.'],
    ...
    {
        pregunta: "Según el artículo 30 de la Ley 39/2015, de 1 de octubre del Procedimiento Administrativo Común de las Administraciones Públicas:",
        opciones: ['Son hábiles las horas comprendidas entre las 8 de la mañana y las 9 de la noche del día.', 'Las horas comprendidas entre las 8 de la mañana y las 9 de la noche de un día hábil.', 'Todas las horas del día que formen parte del día natural.', 'Son hábiles todas las horas del día que formen parte de un día hábil.'],
    ...
    },
    {
        ...
        opciones: ['En el plazo de 30 días desde que expire el plazo máximo para resolver el procedimiento.', 'En el plazo de 20 días desde que expire el plazo máximo para resolver el procedimiento.', 'En el plazo de 10 días desde que expire el plazo máximo para resolver el procedimiento.', 'En el plazo de 15 días desde que expire el plazo máximo para resolver el procedimiento.'],
    ...
    },
    {
        ...
        opciones: ['No cabrá recurso alguno.', 'Procederá el recurso de alzada.', 'Procederá el recurso extraordinario de revisión.', 'Procederá el recurso potestativo de reposición.'],
    ...
    },
    {
        ...
        opciones: ['5 días a partir de la fecha en que el acto haya sido dictado.', '10 días a partir de la fecha en que el acto haya sido dictado.', '15 días a partir de la fecha en que el acto haya sido dictado.', '20 días a partir de la fecha en que el acto haya sido dictado.'],
    ...
    },
    {
        ...
        opciones: ['Cuando esté supeditada a su notificación.', 'Cuando esté supeditada a la aprobación de otro órgano administrativo.', 'En ningún caso podrá quedar demorada.', 'Cuando pueda ser objeto de convalidación.'],
        respuesta: "Cuando esté supeditada a su notificación."
    },
    {
        pregunta: "Dispone la Ley 39/2015, de 1 de octubre, cuando los interesados en un procedimiento administrativo sean desconocidos, se ignore el lugar de la notificación o bien, intentada ésta, no se hubiese podido practicar, la notificación se hará por medio de:",
        opciones: ['Un anuncio publicado en el Boletín Oficial del Estado.', 'Un anuncio en el boletín oficial de la Comunidad autónoma o de la Provincia.', 'Un anuncio en el tablón de edictos del Ayuntamiento del último domicilio del interesado.', 'Un anuncio en un periódico de difusión nacional.'],
        respuesta: "Un anuncio publicado en el Boletín Oficial del Estado."
    },
    {
        pregunta: "Los actos de las Administraciones Públicas sujetos al Derecho Administrativo se presumirán válidos y producirán efectos desde:",
        opciones: ['La fecha en que se dicten, en cualquier caso.', 'La fecha en que se dicten, salvo que en ellos se disponga otra cosa.', 'El día siguiente a la fecha en que se dicten, en cualquier caso.', 'El día siguiente a la fecha en que se dicten, salvo que en ellos se disponga otra cosa.'],
        respuesta: "La fecha en que se dicten, salvo que en ellos se disponga otra cosa."
    },
    {
        pregunta: "De acuerdo con el artículo 35.1 de la Ley 39/2015, de 1 de octubre, ¿cuáles serán motivados, con sucinta referencia de hechos y fundamentos de derecho?",
        opciones: ['Los actos que limiten derechos subjetivos o intereses legítimos.', 'Los actos que limiten derechos objetivos o intereses legítimos.', 'Los actos que amplíen derechos objetivos o intereses legítimos.', 'Los actos que amplíen derechos objetivos o intereses ilegítimos.'],
    ...
    },
    {
        ...
        opciones: ['El titular del órgano superior.', 'El titular del órgano superior o funcionario que la reciba oralmente.', 'El titular del órgano inferior.', 'El titular del órgano inferior o funcionario que la reciba oralmente.'],
        respuesta: "El titular del órgano inferior o funcionario que la reciba oralmente."
    },
    {
        pregunta: "Según el artículo 40.2 de la Ley 39/2015, de 1 de octubre, ¿cuál de los siguientes elementos no es esencial que contenga la notificación de un acto administrativo?",
        opciones: ['La indicación de si el acto pone fin a la vía administrativa.', 'Los recursos que contra él proceden.', 'La indicación de si el acto es o no firme.', 'Los plazos de interposición de los eventuales recursos.'],
        respuesta: "La indicación de si el acto es o no firme."
    },
    {
        pregunta: "Según el artículo 41.3 de la Ley 39/2015, de 1 de octubre, en los procedimientos iniciados a solicitud del interesado, la notificación se practicará:",
        opciones: ['En el domicilio del que tenga conocimiento la Administración.', 'Por el medio señalado al efecto por aquel.', 'En el tablón de anuncios del Ayuntamiento de su residencia.', 'En el Boletín Oficial del Estado.'],
    ...
    },
    {
        ...
        opciones: ['Dentro de los tres días siguientes.', 'Dentro de los cuatro días siguientes.', 'Dentro de los cinco días siguientes.', 'Dentro de los diez días siguientes.'],
    ...
    },
    {
        ...
        opciones: ['Modifican la disposición reglamentaria.', 'Son recurribles.', 'Son nulas.', 'Son prioritarias.'],
        respuesta: "Son nulas."
    },
    {
        pregunta: "Según el artículo 40.1 de la Ley 39/2015, de 1 de octubre, se notificará a los interesados:",
        opciones: ['Toda resolución o acto administrativo, afecte o no a sus derechos e intereses legítimos.', 'Únicamente las resoluciones que afecten a sus intereses.', 'Las resoluciones y actos administrativos que afecten a sus derechos e intereses.', 'Únicamente los actos que afecten a sus intereses.'],
    ...
    {
        pregunta: "Según el artículo 35 de la Ley 39/2015, de 1 de octubre, serán motivados, entre otros, con sucinta referencia de hechos y fundamentos de derecho:",
        opciones: ['Los actos administrativos que se dicten en el ejercicio de potestades discrecionales.', 'Los actos administrativos que amplíen derechos subjetivos o intereses legítimos.', 'Los actos que sigan el criterio establecido en el dictamen de órganos consultivos.', 'Las propuestas de resolución en los procedimientos de responsabilidad patrimonial.'],
        respuesta: "Los actos administrativos que se dicten en el ejercicio de potestades discrecionales."
    },
    {
        pregunta: "Toda notificación deberá ser cursada, según la Ley 39/2015, de 1 de octubre:",
        opciones: ['Dentro del plazo de un mes a partir de la fecha en que el acto haya sido dictado.', 'Dentro del plazo de diez días a partir de la fecha en que el acto haya sido dictado.', 'Dentro del plazo de quince días a partir de la fecha en que el acto haya sido dictado.', 'Dentro del plazo de quince días a partir de la fecha en que el acto haya sido publicado.'],
